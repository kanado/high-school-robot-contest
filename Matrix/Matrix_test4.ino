  ...
  switch (pattern) {
    ...
    case 30:
      ...
      if (aitemu_pos[aitemu_pos_count] >= cm) {
        Motor(0, 0xE4, 0x64, 0x64, 0xE4, 0);
        Serial.println("左");
        pattern = 31;
      } else if (aitemu_pos[aitemu_pos_count] <= cm) {
        Motor(0, 0x64, 0xE4, 0xE4, 0x64, 0);//右
        Serial.println("右");
        pattern = 32;
      }
      break;
    ...
    case  190:      //左：１,右：２,センター:3
      if (data_great_x < center_x) {      //中央より左
        Motor(0, 0x23, 0xA3, 0xA3, 0x23, 0); //右
        delay(100);
        Serial.println("右移動");
      } else if (data_great_x > center_x) {     //中央より右
        Motor(0, 0xA3, 0x23, 0x23, 0xA3, 0); //左
        delay(100);
        Serial.println("左移動");
    ...
    case 200:
      Motor(0, 0xB2, 0xB2, 0x32, 0x32, 0); //前
      pattern = 201;
      delay(1000);
      break;
    ...
    case 213:
      Motor(0, 0x32, 0x32, 0xB2, 0xB2, 0);//後ろ
    ...
    case 216:
      Motor(0, 0x9E, 0x9E, 0x1E, 0x1E, 0); //前
      delay(500);
      Motor(0, 0, 0, 0, 0, 0);
      pattern = 217;
      delay(100);
